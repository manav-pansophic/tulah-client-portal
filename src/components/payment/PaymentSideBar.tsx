    ...
    <>
      ...
      >
        ...
        <Flex h={"100%"} justify={"center"} align={"center"}>
          <Text c={"var(--mantine-color-theme-10)"}>Your basket is empty</Text>
        </Flex>
      </Box>
      ...
      >
        <Flex w={"100%"} h={"max-content"} direction={"column"}>
          ...
          <Flex justify={"space-between"} mt={"lg"} align={"center"}>
            ...
            <Divider color="var(--mantine-color-theme-10)" w={"30%"}></Divider>
            <Text>₹ 15000.00</Text>
          </Flex>
        ...
        <Flex
          ...
          c={"#545454"}
        >
          <Divider color="var(--mantine-color-theme-10)" w={"95%"}></Divider>
          <Flex justify={"space-between"} mt={"lg"} align={"center"} mr={"md"}>
            <Title fz={"h4"}>Subtotal (2 items)</Title>
            <Divider color="var(--mantine-color-theme-10)" w={"35%"}></Divider>
            <Text>₹ 35000.00</Text>
          </Flex>
          <Flex justify={"space-between"} mt={"lg"} align={"center"} mr={"md"}>
          ...
          <Flex justify={"space-between"} my={"lg"} align={"center"} mr={"md"}>
            ...
            <Divider color="var(--mantine-color-theme-10)" w={"20%"}></Divider>
            <Text>₹ 35.82</Text>
          </Flex>
          <Divider color="var(--mantine-color-theme-10)" w={"95%"}></Divider>
          <Flex
