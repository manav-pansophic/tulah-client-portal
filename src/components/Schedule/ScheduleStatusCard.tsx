  ...
  return (
    <>
      {statusType === "INPROGRESS" && (
        <InprogressCard statusType={statusType} />
      )}
      {statusType === "APPROVED" && <ApprovedCard statusType={statusType} />}
      {statusType === "CONFIRMED" && <ConfirmedCard statusType={statusType} />}
